...
namespace Scheduler.Migrations
{
    ...
    [Migration("20180419231542_Added message time")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Scheduler.Models.HealthCenter.ChatMessage", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("ApplicationUserIDFrom");

                    b.Property<string>("ApplicationUserIDTo");
                    ...
                    b.HasIndex("ApplicationUserIDFrom");

                    b.HasIndex("ApplicationUserIDTo");
            ...
            modelBuilder.Entity("Scheduler.Models.HealthCenter.DoctorScheduleTime", b =>
                {
                    b.Property<int>("DoctorID");

                    b.Property<DateTime>("VisitDateTime");

                    b.HasKey("DoctorID", "VisitDateTime");

                    b.ToTable("DoctorScheduleFutureTimes");
                });
            ...
            modelBuilder.Entity("Scheduler.Models.HealthCenter.PatientBan", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Scheduler.Models.HealthCenter.Visit", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Scheduler.Models.HealthCenter.ChatMessage", b =>
                {
                    b.HasOne("Scheduler.Models.ApplicationUser", "FromUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserIDFrom");

                    b.HasOne("Scheduler.Models.ApplicationUser", "ToUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserIDTo");
                });
            ...
            modelBuilder.Entity("Scheduler.Models.HealthCenter.PatientBan", b =>
                {
                    b.HasOne("Scheduler.Models.HealthCenter.Patient", "Patient")
                        .WithMany("Bans")
