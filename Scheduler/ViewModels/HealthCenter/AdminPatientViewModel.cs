...
namespace Scheduler.ViewModels.HealthCenter
{
    public class AdminPatientViewModel
    {
        ...
        public int NotArrivedVisitsCount { get; set; }

        [Display(Name = "All Past Visits Count")]
        public int AllVisitsCount { get; set; }

        [Display(Name = "Not Arrived Percent")]
        public string NotArrivedVisitsPercent { get; set; }
    }
}
